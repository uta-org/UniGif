...
namespace UnityGif
{
    public static partial class UniGif
    {
            ...
            bool debugLog = false)
        {
            ...
            var num = gifData.DecodeTextureCoroutine(result => gifTexList = result, filterMode, wrapMode);
            ...
            {
                Debug.LogErrorFormat("GIF texture decode error. Count: {0}", gifTexList == null ? "Null" : gifTexList.Count.ToString());
