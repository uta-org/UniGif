...
namespace UnityGif
{
    public static partial class UniGif
    {
        ...
        private static IEnumerator DecodeTextureCoroutine(this GifData gifData, Action<List<GifTexture>> callback, FilterMode filterMode, TextureWrapMode wrapMode)
        {
            if (gifData.Equals(default(GifData)))
            {
